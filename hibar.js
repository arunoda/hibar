...
var hibar_template=" <!--[if gte IE 9]> <style type='text/css'> .gradient { filter: none; } </style> <![endif]--> <div id='hi-bar'> <div id='hi-bar-content'><span id='hi-bar-title'>This is the new alternative for hello bar</span> <a id='hi-bar-link' href='#' target='_blank'>Download Here<a></div> <div id='hi-bar-close'>x</div> </div> <div id='hi-bar-open'> HI BAR </div> ";
/*!
