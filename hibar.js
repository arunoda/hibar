...
}var hibar_css=" #hi-bar{position:fixed;top:0;left:0;right:0;display:none}#hi-bar-content{background-color:#EB593C;padding:8px 0 8px 0;box-shadow:0 0 5px #333;color:#fff;font-size:14px;font-family:Georgia}#hi-bar a{background-color:#333;color:#ddd;padding:2px 10px 2px 10px;font-size:12px;box-shadow:0 0 2px #000;border-radius:10px;font-family:Tahoma;margin-left:5px}#hi-bar a:hover{box-shadow:0 0 4px #000}#hi-bar-close{position:absolute;right:20px;top:6px;color:#fff;padding:0;font-size:20px;line-height:20px;font-family:arial;font-weight:700;cursor:pointer}#hi-bar-open{position:fixed;top:-5px;right:25px;background-color:#EB593C;padding:15px 6px 5px 6px;color:#fff;font-family:Arial;font-size:12px;font-weight:700;border:3px solid white;border-radius:3px;box-shadow:0 0 10px #ccc;cursor:pointer} ";
